...
AXPETDetectorConstruction::SelectDetector( const G4String& val )
{
 ...
 // Test for Problem Report with Optical Photons and Sphere or Ellipsoid
     ...
     G4Sphere *newSIn = new G4Sphere("Crystal",0.,lysoR-4.01/mm,0,twopi,0,twopi);   aVolume = new G4SubtractionSolid("OutsideminInside", newSOut, newSIn);     
  ...
  else if (val == "PolyconeGen")
  {
   ...
   { //has to be apdated
    G4double        zPlanes[]=
    {-1.1640*mm,    -1.1640*mm,     -1.1570722*mm,  -0.9766005*mm,  
     -0.4487828*mm,  0.4487828*mm,   0.9766005*mm,   1.1570722*mm,  
      1.1640*mm,     1.1640*mm,      1.1580*mm,      0.9750*mm,
      0.4500*mm,    -0.4500*mm,     -0.9750*mm,     -1.1580*mm,
					     -1.1640*mm};
  
    G4double        radius[]        =     
   {0.250*mm,       0.305*mm,        0.305*mm,     2.770461*mm,
    4.932*mm,       4.932*mm,        2.770461*mm,  2.770461*mm,
    0.305*mm,       0.250*mm,        0.250*mm,     2.750*mm,
    4.900*mm,       4.900*mm,        2.750*mm,     0.250*mm,
						   0.250*mm};
...
else if (val == "ExtrudedSolid")
  {
   ...
   aVolume = new G4ExtrudedSolid("aExtrudedSolid", polygon, zsections);
    ...
    { 
      VUSolid* tmp=new UBox( "interactiveUBox",3.,1.,0.5);
      aVolume = new G4USolid("interactiveUBox",tmp );
    }
