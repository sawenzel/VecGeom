...
public:
   UVector3() {x=y=z=0.0;}
   UVector3( double xval, double yval, double zval ) { x=xval; y=yval; z=zval; }  
   UVector3( double theta, double phi );
   UVector3( const double coord[3] ) { x=coord[0]; y=coord[1]; z=coord[2]; }
...
inline double UVector3::Mag2() const { return x*x + y*y + z*z; }

inline double UVector3::Perp2() const { return x*x + y*y; }
