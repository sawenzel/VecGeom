#ifndef USOLIDS_UVoxelizerCHAR
#define USOLIDS_UVoxelizerCHAR
...
public:
   ...
   UVoxelizerCHAR();
   UVoxelizerCHAR(UMultiUnion* multi_union);
   ~UVoxelizerCHAR();
...
private:
   ...
   char *BuildListNodes(double *boundaries, int boundariesCount, int offset);

   UBits *BuildListNodesBits(double *boundaries, int boundariesCount, int offset);

   void DisplayListNodes(double *boundaries, int boundariesCount, char *bitmask);
...
//   int               *fNumNodesSliceX;       // Number of nodes in the considered slice along X axis
   ...
   char              *bitmaskX, *bitmaskY, *bitmaskZ;              // Each character of "memory" contains the nodes present in the considered slice
