...
void test7()
{
	...
	for(int i=0;i<1000000;++i)
	{
		...
		if ( vol1 != NULL )
		{
			std::cerr << RootGeoManager::Instance().tgeonode( vol1 )->GetName() << std::endl;
		}
*/
	...
	/*
		if ( vol2 != NULL )
		{
			std::cerr << "new node " << RootGeoManager::Instance().tgeonode( vol2 )->GetName() << std::endl;
...
int main()
{
    ...
    RootGeoManager::Instance().world()->logical_volume()->PrintContent();
