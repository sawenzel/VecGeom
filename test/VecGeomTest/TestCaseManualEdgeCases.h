...
inline const std::vector<ManualEdgeCase> &GetManualEdgeCases()
{
  static const std::vector<ManualEdgeCase> cases = {
      ...
      {"tube_fullphi_outer_r_shallow_overlap_band", "tube_fullphi", "surface", ShapeSampleCategory::kSurface,
       Vec_t(10., 0., 0.), Vec_t(-7.e-11, 1., 0.), false, Vec_t(0., 0., 0.), 0.,
       "Outer-radius shallow ray in the former DistanceToIn/DistanceToOut zero-overlap band."},
