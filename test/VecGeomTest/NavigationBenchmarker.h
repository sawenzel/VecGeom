...
Precision benchmarkLocatePoint(VPlacedVolume const *top, int nPoints, int nReps, SOA3D<Precision> const &points);

Precision benchmarkSerialNavigation(VPlacedVolume const *top, int nPoints, int nReps, SOA3D<Precision> const &points,
                                    SOA3D<Precision> const &dirs, Precision const *maxSteps);

Precision benchmarkVectorNavigation(VPlacedVolume const *top, int nPoints, int nReps, SOA3D<Precision> const &points,
                                    SOA3D<Precision> const &dirs, Precision const *maxSteps);

void runNavigationBenchmarks(LogicalVolume const *vol, int np, int nreps, Precision const *maxStep,
                             Precision bias = 0.8);
...
#ifdef VECGEOM_ROOT
Precision benchmarkROOTNavigation(VPlacedVolume const *top, int nPoints, int nReps, SOA3D<Precision> const &points,
                                  SOA3D<Precision> const &dirs);
#endif

#ifdef VECGEOM_ENABLE_CUDA
Precision runNavigationCuda(void *gpu_ptr, void *gpu_out_ptr, VPlacedVolume const *volume, unsigned npoints,
