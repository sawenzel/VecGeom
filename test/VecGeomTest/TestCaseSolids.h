...
inline const std::vector<TestCaseSolid> &GetTestCaseSolids()
{
  ...
  static const std::vector<TestCaseSolid> solids = {
      ...
      {"boolean_union_offset_boxes", &MakeBooleanUnionOffsetBoxesTestSolid, "BooleanUnionImplementation",
       ...
       false, false, kPlanarTolerance},
      {"boolean_union_rotated_touching_boxes", &MakeBooleanUnionRotatedTouchingBoxesTestSolid,
       "BooleanUnionImplementation", MakeFastContractSampling(10000, 77, 55, 4., 25.),
       MakeMediumContractSampling(100000, 77, 55, 4., 25.), {}, false, false, kPlanarTolerance},
      {"boolean_union_overlapping_tube_cone", &MakeBooleanUnionOverlappingTubeConeTestSolid,
       "BooleanUnionImplementation", MakeFastContractSampling(10000, 79, 57, 4., 25.),
       MakeMediumContractSampling(100000, 79, 57, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_union_disjoint_tubes", &MakeBooleanUnionDisjointTubesTestSolid, "BooleanUnionImplementation",
       MakeFastContractSampling(10000, 80, 58, 4., 25.), MakeMediumContractSampling(100000, 80, 58, 4., 25.), {},
       false, false, kSecondOrderTolerance},
      {"boolean_intersection_box_tube", &MakeBooleanIntersectionBoxTubeTestSolid, "BooleanIntersectionImplementation",
       ...
       false, false, kSecondOrderTolerance},
      {"boolean_intersection_rotated_boxes", &MakeBooleanIntersectionRotatedBoxesTestSolid,
       "BooleanIntersectionImplementation", MakeFastContractSampling(10000, 78, 56, 4., 25.),
       MakeMediumContractSampling(100000, 78, 56, 4., 25.), {}, false, false, kPlanarTolerance},
      {"boolean_intersection_rotated_tube_cone", &MakeBooleanIntersectionRotatedTubeConeTestSolid,
       "BooleanIntersectionImplementation", MakeFastContractSampling(10000, 81, 59, 4., 25.),
       MakeMediumContractSampling(100000, 81, 59, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_intersection_nested_union", &MakeBooleanIntersectionNestedUnionTestSolid,
       "BooleanIntersectionImplementation", MakeFastContractSampling(10000, 82, 60, 4., 25.),
       MakeMediumContractSampling(100000, 82, 60, 4., 25.), {}, false, false, kSecondOrderTolerance},
      ...
      {"boolean_subtraction_box_halfspace", &MakeBooleanSubtractionBoxHalfSpaceTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 95, 73, 4., 25.),
       MakeMediumContractSampling(100000, 95, 73, 4., 25.), {}, false, false, kPlanarTolerance},
      {"boolean_subtraction_tube_halfspace", &MakeBooleanSubtractionTubeHalfSpaceTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 97, 75, 4., 25.),
       MakeMediumContractSampling(100000, 97, 75, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_halfspace_union_from_box", &MakeBooleanSubtractionHalfSpaceUnionFromBoxTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 96, 74, 4., 25.),
       MakeMediumContractSampling(100000, 96, 74, 4., 25.), {}, false, false, kPlanarTolerance},
      {"boolean_subtraction_tube_from_cone", &MakeBooleanSubtractionTubeFromConeTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 83, 61, 4., 25.),
       MakeMediumContractSampling(100000, 83, 61, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_union_from_box", &MakeBooleanSubtractionUnionFromBoxTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 84, 62, 4., 25.),
       MakeMediumContractSampling(100000, 84, 62, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_exact_phi_wedge", &MakeBooleanSubtractionExactPhiWedgeTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 88, 66, 4., 25.),
       MakeMediumContractSampling(100000, 88, 66, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_union_of_subtractions", &MakeBooleanUnionOfSubtractionsTestSolid, "BooleanUnionImplementation",
       MakeFastContractSampling(10000, 85, 63, 4., 25.), MakeMediumContractSampling(100000, 85, 63, 4., 25.), {},
       false, false, kSecondOrderTolerance},
      {"boolean_intersection_of_subtractions", &MakeBooleanIntersectionOfSubtractionsTestSolid,
       "BooleanIntersectionImplementation", MakeFastContractSampling(10000, 86, 64, 4., 25.),
       MakeMediumContractSampling(100000, 86, 64, 4., 25.), {}, false, false, kSecondOrderTolerance},
      // Nested union-minus-cutter coverage where a transformed subtraction
      // operand shares an exact face with one transformed union component.
      {"boolean_nested_transformed_subtraction", &MakeBooleanNestedTransformedSubtractionTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 94, 72, 4., 25.),
       MakeMediumContractSampling(100000, 94, 72, 4., 25.), {}, false, false, kPlanarTolerance},
      {"boolean_subtraction_exact_polycone_sections", &MakeBooleanSubtractionExactPolyconeSectionsTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 87, 65, 4., 25.),
       MakeMediumContractSampling(100000, 87, 65, 4., 25.), {}, false, false, kSecondOrderTolerance},
      // Polyhedron-left subtraction coverage for exact shared planes/shells,
      // side-cut mixed-boundary contacts, transformed phi seams, and tolerance
      // scale near-coincident faces.
      {"boolean_subtraction_polyhedron_exact_z_slab", &MakeBooleanSubtractionPolyhedronExactZSlabTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 89, 67, 4., 25.),
       MakeMediumContractSampling(100000, 89, 67, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_polyhedron_exact_radial_shell",
       &MakeBooleanSubtractionPolyhedronExactRadialShellTestSolid, "BooleanImplementation<vecgeom::kSubtraction>",
       MakeFastContractSampling(10000, 90, 68, 4., 25.), MakeMediumContractSampling(100000, 90, 68, 4., 25.), {},
       false, false, kSecondOrderTolerance},
      {"boolean_subtraction_polyhedron_side_cut_tube", &MakeBooleanSubtractionPolyhedronSideCutTubeTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 91, 69, 4., 25.),
       MakeMediumContractSampling(100000, 91, 69, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_polyhedron_phi_seam_rotated", &MakeBooleanSubtractionPolyhedronPhiSeamRotatedTestSolid,
       "BooleanImplementation<vecgeom::kSubtraction>", MakeFastContractSampling(10000, 92, 70, 4., 25.),
       MakeMediumContractSampling(100000, 92, 70, 4., 25.), {}, false, false, kSecondOrderTolerance},
      {"boolean_subtraction_polyhedron_near_coincident", &MakeBooleanSubtractionPolyhedronNearCoincidentTestSolid,
