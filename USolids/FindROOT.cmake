...
set(ROOT_ALL_COMPONENTS Core Cint Reflex RIO Hist Tree TreePlayer Cintex Matrix GenVector MathCore XMLIO)
# and build tools
...
foreach(component ${ROOT_FIND_COMPONENTS} Core Cint Reflex)
  ...
  if(NOT ROOT_${component}_LIBRARY)
    message("Finding ROOT_"${component} "_LIBRARY at "${ROOT_LIBRARY_DIRS})

if (NOT WIN32)
    set(findcomponent ${component})
else()
    set(findcomponent lib${component})
endif()

    find_library(ROOT_${component}_LIBRARY NAMES ${findcomponent}
...
if (NOT WIN32)
    set(ROOT_LIBRARIES ${ROOT_LIBRARIES} dl)
endif()
